...
def main(words):
    ...
    if len(words) > 0 and type(words) is list:
        ...
        return "This HTTP triggered function executed successfully. Pass a word in the query string or in the request body for a personalized response."
